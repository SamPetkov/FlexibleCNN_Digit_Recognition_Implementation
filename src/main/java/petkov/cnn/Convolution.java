 ...
 *
 * @author: sam_petkov ( based on code by Simon Horne) 10.05.2021
 */
public class Convolution extends Thread {
    ...
    // We get an int output of the convolution matrix
    ...
    // Takes a 2D array of grey-levels and a kernel,
    //applies the convolution over the area of the image specified by width and height and 
    // returns a part of the final image.
