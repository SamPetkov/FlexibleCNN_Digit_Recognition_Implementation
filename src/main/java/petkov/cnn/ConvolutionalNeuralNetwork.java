...
/**
 * Created by sam_petkov on 10.05.2021
 */
public class ConvolutionalNeuralNetwork {
    // parameters
    private static final String OUT_DIR = "C:\\Users\\petko\\Documents\\GitHub\\DigitRecognizer\\resources\\cnnCurrentTrainingModels";
    private static final String TRAINED_MODEL_FILE = "C:\\Users\\petko\\Documents\\GitHub\\DigitRecognizer\\resources\\cnnTrainedModels\\bestModel.bin";
    ...
    // We initialize the CNN
    public void init() throws IOException {
        preTrainedModel = ModelSerializer.restoreMultiLayerNetwork(new File(TRAINED_MODEL_FILE));
        //preTrainedModel = ModelSerializer.restoreMultiLayerNetwork(new File(System.getProperty("user.dir") + TRAINED_MODEL_FILE));
    }
    // We get the CNN's prediction
    ...
    // Method for training the CNN ( which has 6 layers of neurons)
    public void train(Integer trainDataSize, Integer testDataSize) throws IOException {
        ...
        int seed = 123; //We get the "id" of the CNN
